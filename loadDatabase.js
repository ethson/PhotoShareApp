...
var cs142PassMaker = require('./cs142password');
...
Promise.all(removePromises).then(function () {
    ...
    var userPromises = userModels.map(function (user) {
        var passWordEntryHash = cs142PassMaker.makePasswordEntry('weak');
        return User.create({
            ...
            password_digest: passWordEntryHash.hash,
            salt: passWordEntryHash.salt
            //password: 'weak'
